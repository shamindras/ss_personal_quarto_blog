...
image-alt: "Screenshot of Disqus comment setup for upgrading Distill blog settings"
execute:
  echo: true
---
...
[RStudio](https://www.rstudio.com/){target="_blank"} team.
...
Fortunately `distill` comes with easy to configure settings as we will see below.
...
As a student I've got to always know when to get a freebie `r emo::ji("smile")`
...
following configuration options. I particularly like setting an opinionated
...
lets me quickly know whether my website is up and running as expected by simply
