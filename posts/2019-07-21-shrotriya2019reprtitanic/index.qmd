...
categories: [reproducibility, rstats, tidyverse]
date: "2019-07-21"
image: images/logo-01.jpg
image-alt: "Hex sticker logo for the Titanic survivors reproducibility post"
...
#| fig-alt: "Horizontal bar chart of Titanic passengers and crew, faceted by class, showing counts of saved versus not saved by sex"
out_plot <- ttnc_cln %>%
              ggplot(data = .,
...
-   **Summary:** Overall this was a really fun challenge and I learned a lot
    about old-school data visualization using the glorious modern `tidyverse`
