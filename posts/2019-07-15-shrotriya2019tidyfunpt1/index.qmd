...
description: |
  ...
  entries
categories: [rstats, tidyverse]
date: "2019-07-15"
image: images/logo-01.jpg
image-alt: "Hex sticker logo for the Tidyverse Fun Part 1 post"
...
made a compelling argument on its apparent general lack of ambiguity when
...
::: {.column-margin}
__Note:__ The `tidyr::crossing` generates a *Cartesian product* of all
the 3 word triples, very handy
:::
...
::: {.column-margin}
__Note:__ Luckily we don't have _literal_ angle brackets in our BibTeX
output to deal with here
:::
...
{{< include ../../data/qmds/includes/_acknowledgment-salil-hex.qmd >}}
