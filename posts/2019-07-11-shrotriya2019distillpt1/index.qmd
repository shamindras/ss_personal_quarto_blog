...
image-alt: "Screenshot of Netlify custom domain setup for a Distill blog"
execute:
  echo: true
---

::: {.callout-important title="Historical Post" appearance="default"}
This post documents the original [Distill](https://rstudio.github.io/distill/)-based
blog setup and is preserved for historical reference. The blog now runs on
[Quarto](https://quarto.org/), and comments use [giscus](https://giscus.app/) instead
of Disqus. See the [GitHub repo](https://github.com/shamindras/ss_personal_quarto_blog)
for the updated Quarto source code.
:::
...
[RStudio](https://www.rstudio.com/){target="_blank"} team. The main tools I used
...
The details of *how* I used these tools are all noted below in a step-by-step
manner.
...
personal `github` account and created a new repository. I called mine
`ss_personal_distill_blog` and also initialized it with a `README.md` and
included an `.gitignore` for `R` since that will be the blogging
language of choice here `r emo::ji("smile")`. This is shown in the screenshot below.
...
``` markup
_posts/2019-07-10-welcome-to-shamindras-blog/welcome-to-shamindras-blog.Rmd
```
...
instructions on Netlify website.
...
I clicked the **Site Settings** button. Looks like my site name on `Netlify` is
...
every time you refresh them and deploy our website accordingly
...
routed to the blog. So I don't even need to write the `www.` going forward.
...
[www.shamindras.com](https://www.shamindras.com){target="_blank"}. So effectively
