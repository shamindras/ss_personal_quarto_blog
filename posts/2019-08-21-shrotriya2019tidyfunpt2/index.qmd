...
image-alt: "Hex sticker logo for the Tidyverse Fun Part 2 post"
execute:
  echo: true
---
...
$\mathbf{A}$ i.e the lowercase/uppercase `mathbf` commands respectively.
...
`stringr` similar to this [previous post
...
The function then outputs a single `newcommand` entry for that letter i.e
