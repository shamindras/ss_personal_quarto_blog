...
slug: shrotriya2022sharplpnormconsts
date: "2022-05-12"
image: images/preview-shrotriya2021normtriconvexity.png
image-alt: "Preview thumbnail for sharp constants in finite dimensional Lp norms post"
execute:
  echo: true
draft: true
---
...
I walk through a cool and possibly less known result for sharp bounds
on $\ell_{p}$ norms in finite dimensional vector spaces. This result enables working with 
$\ell_{p}$-norms directly rather than approximating them with more widely 
...
Throughout this presentation we will work in the finite dimensional
Euclidean space $\mathbb{R}^{d}$, for some __fixed__
$d \in \mathbb{N}$. Moreover we will use the $\ell_{p}$-norm on
this space, which is defined as follows:
