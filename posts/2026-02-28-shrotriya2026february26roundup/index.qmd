...
>    markdown *simplify* his blogging experience with Movable Type.
...
to. I had heard all of the "spark joy" memes when the Netflix show
landed, and simply assumed this was another decluttering gimmick and
ignored it. How wrong I was. This is a very deep book about life
prioritization disguised as a home tidying manifesto. I learned many
practical skills, but the main four biggest takeaways were as follows.
...
A overarching theme of the book is that tidying is only the *first*
...
dealbreakers and could be supplmented with more modern literature. Would
recommend.
...
>    small stuff", i.e. details matter. Here is emphasises the notion of
