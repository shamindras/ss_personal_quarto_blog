...
This was a really important historical overview over the rise of one of the most ubiquitous[^fn-markdown-llms] text document formats used on the web, i.e. [markdown](https://daringfireball.net/projects/markdown/). Dash worked at Movable Type, an influential blogging platform in the early 21st century. Key takeaways:
...
[^fn-markdown-llms]: And increasingly so, with modern LLM specification docs like
